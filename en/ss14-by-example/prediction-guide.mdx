...
See [this guide](basic-networking-and-you) for basic information on how to network components, which will be required knowledge for this tutorial. 
...
This will need further engine changes in the future, see [Entity spawn prediction v2](https://github.com/space-wizards-federation/RobustToolbox/issues/5845).
...
`IsFirstTimePredicted` is currently [misused all across the codebase](https://github.com/space-wizards-federation/space-station-14/issues/41116) to hide mispredicts, so don't trust existing code on this. This does not fix the underlying problem but rather disables prediction.
...
In the future Robust Toolbox will have methods for predicted randomness, but at the time of writing the [PR for RandomPredicted](https://github.com/space-wizards-federation/RobustToolbox/pull/5849) has not been merged yet.
...
See [this issue](https://github.com/space-wizards-federation/RobustToolbox/issues/6152) for more details.
...
There is currently some weird behaviour with solution entities and PVS, which may cause debug asserts under specific circumstances and will need a workaround, see [this PR](https://github.com/space-wizards-federation/space-station-14/pull/35314). I'm mentioning this here because this is tricky to figure out otherwise.
...
See [this issue](https://github.com/space-wizards-federation/space-station-14/issues/42218) for the current state of this problem.
...
See [this issue](https://github.com/space-wizards-federation/RobustToolbox/issues/5194) for the current state of this problem.
