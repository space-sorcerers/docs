...
But before you can start ~~sacrificing puppies~~ making fancy UIs using our UI system you first need to know how to define a basic UI layout so I recommend reading the [basic user interface documentation](../robust-toolbox/user-interface) first.
...
One of the best examples to look at is the [GravityGeneratorWindow](https://github.com/space-wizards-federation/space-station-14/blob/master/Content.Client/Gravity/UI/GravityGeneratorWindow.xaml).
...
Taking a look at [StyleNano.cs](https://github.com/space-wizards-federation/space-station-14/tree/master/Content.Client/Stylesheets/StyleNano.cs) will ~~instill you with fear~~ overwhelm you with its 1318 lines of code.
...
Here (and a similiar construct in [StyleBase.cs](https://github.com/space-wizards-federation/space-station-14/tree/master/Content.Client/Stylesheets/StyleBase.cs)) is where you can look up and add style classes.
