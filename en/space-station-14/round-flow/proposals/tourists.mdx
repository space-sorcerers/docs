...
|---|---|---|
| SlamBamActionman* | ⚠️ Partially | Travel Camera: space-wizards-federation/space-station-14#24085<br /> Visitor Job: space-wizards-federation/space-station-14#23972<br />Tourist Role: TBA|
...
- A backpack, containing:
  - A few randomly selected clothing items (similar to [DresserFilled](https://github.com/space-wizards-federation/space-station-14/blob/03f0257ae9b0c3d2d349bd2bcc4670a7ac92e139/Resources/Prototypes/Entities/Structures/Furniture/dresser.yml#L50)).
  - A survival box.
