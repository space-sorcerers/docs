...
This content was removed in [#26978](https://github.com/space-wizards-federation/space-station-14/pull/26978) due to the following:
...
|------------|------------------------|--------------------------------------------------------------|
| deltanedas | :white_check_mark: Yes | https://github.com/space-wizards-federation/space-station-14/pull/19946 |
