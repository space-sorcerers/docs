...
<Note title="Quiet shift today">

</Note>
<Note title="I found a cobra or some other syndicate tech on station/a syndicate has done something noticable. Main round antag is traitors.">

</Note>
<Note title="It's been strangely quiet and nothing has really happened in the first 30 minutes. Probably nukies">

</Note>
Can be solved by adding single Traitors to non-Traitor gamemodes: https://github.com/space-wizards-federation/space-station-14/pull/27501
...
Can be solved by making map loot spawn randomly: https://github.com/space-wizards-federation/space-station-14/pull/27082

### Overly suspicious players
<Note title="I heard a flash somehwe near security, it must be revs! Cargo buy mindshields immediately">

</Note>
<Note>
YOOOOOOO YA WANT A STAMP FOR SOMETING NOT THAT IMPORTANT?, YA GONNA USE CYBERSUN PEN FOR EDITING THE PAPER!!, KOS
</Note>
Can be solved by having a non-antag role mimicing antag behavior: https://github.com/space-wizards-federation/docs/pull/129
