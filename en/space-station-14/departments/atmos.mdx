...
<Info>
Elaborations and examples for these design principles are available in the [atmospherics design choices document](atmos/atmos-design-choices).
</Info>
...
### [Intuitive and Inter-Connected Simulation](../core-design) (Quasi-Realistic Simulation)
