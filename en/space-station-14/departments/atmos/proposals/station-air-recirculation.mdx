---
title: "Station Air Recirculation (HVAC)"
---


| Designers      | Implemented | GitHub Links                                                                                                                  |
|----------------|-------------|-------------------------------------------------------------------------------------------------------------------------------|
| ArtisticRoomba | :x: No      | [Atmos Circulation](https://github.com/space-wizards-federation/space-station-14/pull/33380)<br/>Mapping PRs TBD when first PR is merged |
...
4. **Flow-based atmospherics PR can be merged**
   - After all of this, the [flow-based atmospherics PR](https://github.com/space-wizards-federation/space-station-14/pull/33380) can be merged. This is further explained in **Required Core System Changes**.
