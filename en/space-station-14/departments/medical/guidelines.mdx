...
Medical related PRs should, in their description or title, state whether this change is meant to be for the current upstream medical system or for debodying/disco-med (See [Medical Workgroup Document](medical-workgroup)). A PR without clear intention may be subject to closure if it does not follow the guidelines for either current upstream medical, or disco-med. 
...
For more questions on Debodying and Disco-Med please see: [Medical Workgroup Document](medical-workgroup)
