---
title: "Vulpkanin Species"
---


| Designers | Implemented   | GitHub Links                                                                      |
|---|---------------|-----------------------------------------------------------------------------------|
| ScarKy0 | :x: Partially | [Implementation PR](https://github.com/space-wizards-federation/space-station-14/pull/37539) |
...
Playing as Vulpkanin was popular during their [temporary release during the 2025 April Fools event.](https://github.com/space-wizards-federation/space-station-14/pull/35395) During the event, players could play as an early draft of Vulpkanin, and the species received a lot of positive feedback.
