---
title: "Writing Guidebook Entries"
---
...
This guide explains how to write a guidebook entry and set it up in game as well as provides helpful tips for creating good quality entries. Afterwards, if you want to learn how to make a pull request for your new entry, check out [Git for the SS14 Developer](../setup/git-for-the-ss14-developer).
...
- `[color=hex or name][/color]` colors the text inside the tags with a specified hex color or one of 145 [presets](https://github.com/space-wizards-federation/RobustToolbox/blob/f49b01b1b766458f61a38506dd3e2fa7525f5e6b/Robust.Shared.Maths/Color.cs#L1749)
...
You can learn more about localization [here](../../ss14-by-example/fluent-and-localization).
