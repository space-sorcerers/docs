...
First, you will need to fork the [engine](https://github.com/space-wizards-federation/RobustToolbox). You can then change your git remotes inside the submodule so that you can work against your fork:
...
The supported formats can be found at https://github.com/space-wizards-federation/submodule-dependency
