...
Go to [Issues in Space Station 14](https://github.com/space-wizards-federation/space-station-14/issues)
- Choose 1 or more of the following labels in [Labels](https://github.com/space-wizards-federation/space-station-14/labels)
...
3. [No C#](https://github.com/space-wizards-federation/space-station-14/labels/Changes%3A%20No%20C%23) to work on issues that require no code. 
...
<Danger title="Make a new branch so you are not working on the master branch!">
...
3. Open a New Issue on Space Station 14: [New Issue](https://github.com/space-wizards-federation/space-station-14/issues/new/choose)
...
2. If YML files are not showing up, you can find them on Github by going to the [Space Station 14 repository](https://github.com/space-wizards-federation/space-station-14?search=1) & searching for .yml files.
