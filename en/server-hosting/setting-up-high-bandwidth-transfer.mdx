---
title: "Setting up High Bandwidth Transfer"
---


As of [Robust Toolbox Version 271.1.0](https://github.com/space-wizards-federation/RobustToolbox/blob/40b10f0dccfe568ccd7dc3c6f6ee87a63bad97ee/RELEASE-NOTES#27110) the engine supports a "high bandwidth" transfer mode utilizing WebSockets. This enables features like admin resource upload/download to have higher bandwidth than supported by the game's normal networking layer, but requires some additional server setup. Content may implement additional features through the `ITransferManager` interface.
...
### Game server config
The main [CVars](https://github.com/space-wizards-federation/RobustToolbox/blob/40b10f0dccfe568ccd7dc3c6f6ee87a63bad97ee/Robust.Shared/CVars.cs#L409-L448) are located here (Note this is a permalink, more CVars may exist by the time this page was written).
...
<Warning title="Be sure to reload and not restart!">
