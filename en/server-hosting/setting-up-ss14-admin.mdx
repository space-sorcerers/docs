---
title: "Setting up SS14.Admin"
---

[SS14.Admin](https://github.com/space-wizards-federation/SS14.Admin/) is a web-based panel for administration of SS14 servers, providing various [features](../community/admin/admin-tooling#ss14admin) critical for serious servers.

This document will explain what you will need to set yourself up with your own instance of SS14.Admin.

## Overview

SS14.Admin connects directly to your game server's database, allowing it to view all data on players, bans, admins, etc. This is then accessible to game server administrators via their web browser. Admins log into SS14.Admin directly with their SS14 account, via [OAuth](../server-hosting/oauth).
...
The latest stable image of SS14.Admin is `ghcr.io/space-wizards-federation/ss14.admin:1`. Information about the container:
...
For admins to be able to log in directly with their SS14 account, you need to register an [OAuth client](../server-hosting/oauth) as follows:
...
*See also: [troubleshooting in the main OAuth page](./oauth#auth-side-an-error-occurred-while-processing-your-request).*
