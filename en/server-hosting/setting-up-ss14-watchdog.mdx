---
title: "Setting up SS14.Watchdog"
---
...
It may also be useful to familiarize yourself with [setting up a developer environment](../general-development/setup/setting-up-a-development-environment), as you will need at least `dotnet` installed to compile the Watchdog, and Python installed to run certain server build scripts.
...
Manifest type is the method all Wizard's Den servers use and we recommend using. Manifest is required to be able to record [replays](../server-hosting/server-replay-recording)
