...
2. Fetch latest master (`git fetch https://github.com/space-wizards-federation/RobustToolbox.git`)
...
5. Push your commit and tag to RobustToolbox (`git push` and `git push https://github.com/space-wizards-federation/RobustToolbox.git v0.1.0`, WITH 'v')
