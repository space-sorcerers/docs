...
<Info>
For a solid, real example of ECS in action on our codebase, take a look at [Stacks](https://github.com/space-wizards-federation/space-station-14/pull/4046) and [Actors](https://github.com/space-wizards-federation/RobustToolbox/pull/1774).
</Info>
