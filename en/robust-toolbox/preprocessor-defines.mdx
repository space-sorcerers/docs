...
* `RELEASE`: The game is being compiled on the [`Release` build configuration](./build-configurations). You generally should not need to check this, instead opt to check for `DEBUG` and `TOOLS` where applicable.
