...
Users can provide extra sound fonts in their [user data directory](user-data-directory), under the path `/soundfonts/`. All sound fonts in this directory (if it exists, it is not created by default) will be loaded.
