...
[RSIEdit](https://github.com/space-wizards/RSIEdit) is a GUI application for creating and editing RSI files. It also supports converting `.dmi` files (BYOND/SS13) to RSI format.

Downloads for Windows, Linux, and macOS are available on the [Releases page](https://github.com/space-wizards/RSIEdit/releases).
