---
title: "Testing unpublished engines against launcher"
---
...
Download [SS14.Launcher](https://github.com/space-wizards-federation/SS14.Launcher) from GitHub, compile it, yada yada. You'll notice you have a very funny button when you run it:
